...
/* .......................................................................... */
  ...
  */
  function getMovieInfo( n, nodeArray ) {
    ...
    info = '<div id="cover">';
    if( n.cover )
      info += '<img class="cover" width="300" height="300" src="' + n.cover + '" title="' + n.label + '"/>';
    else
    ...
    if( n.tag )
      info += '<div class=f><span class=l>Tag </span>: <span class=d>' 
           + n.tag + '</span></div>';
    if( n.attribute_1 )
      info += '<div class=f><span class=l>Attribute_1 </span>: <span class=d>' 
           + n.attribute_1 + '</span></div>';
    if( n.attribute_2 )
      info += '<div class=f><span class=l>Attribute_2 </span>: <span class=d>' 
           + n.attribute_2 + '</span></div>';
    if( n.attribute_3 )
      info += '<div class=f><span class=l>Attribute_3 </span>: <span class=d>' 
           + n.attribute_3 + '</span></div>';
    if( n.score )
      info += '<div class=f><span class=l>Score </span>: <span class=d>' 
           + n.score + '</span></div>';
    if( n.title )
      info += '<div class=f><span class=l>Title </span>: <span class=d>' 
           + n.title + '</span></div>';
    if( n.links ) {
